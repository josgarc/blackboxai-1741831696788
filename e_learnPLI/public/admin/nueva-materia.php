...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->execute([$courseData['codigo']]);
        ...
        if ($courseManager->createCourse($courseData)) {
            ...
            header("refresh:2;url=materias.php");
        } else {
...
<head>
    ...
    <title>Nueva Materia - E-Learning PLI</title>
    <!-- Tailwind CSS -->
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"><?php echo isset($_POST['descripcion']) ? htmlspecialchars($_POST['descripcion']) : ''; ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="creditos" id="creditos" min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                value="<?php echo isset($_POST['creditos']) ? (int)$_POST['creditos'] : '0'; ?>">
                        </div>
                            ...
                            <select name="maestro_id" id="maestro_id"
                                ...
                                <?php foreach ($profesores as $profesor): ?>
                                    <option value="<?php echo $profesor['id']; ?>" 
                                        <?php echo (isset($_POST['maestro_id']) && (int)$_POST['maestro_id'] === $profesor['id']) ? 'selected' : ''; ?>>
